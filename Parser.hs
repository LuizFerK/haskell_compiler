...
happyExpList = Happy_Data_Array.listArray (0,298) ([28704,1574,8,0,0,32768,39423,24,0,0,0,512,25191,0,0,0,2,39944,393,8192,0,2048,0,0,8,0,65026,26215,0,32,65504,1574,0,0,26370,32866,39360,8216,9840,2054,35228,513,25191,49280,6297,0,0,128,0,0,0,24,16384,7,49152,1,512,25191,0,1664,0,0,39944,393,26370,32866,39423,57432,9855,22,1024,0,6656,0,0,0,0,57336,393,26370,98,16384,8192,9840,2054,35228,513,25191,0,0,0,0,0,0,0,26,31,0,16384,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Exp","Type","num","'*'","'+'","\"&&\"","\"==\"","'>'","'%'","true","false","if","then","else","var","'\\\\'","':'","\"->\"","'('","')'","Bool","Number","letrec","let","'='","in","%eof"]
...
action_12 (28) = happyShift action_34
...
action_24 (11) = happyShift action_22
action_24 (12) = happyShift action_23
...
action_31 (25) = happyShift action_40
...
action_38 (22) = happyShift action_38
